...
export const COUPON_STATUS_LABEL: Record<CouponStatus, string> = { ISSUED: "사용 가능", REDEEMED: "사용됨", EXPIRED: "만료", CANCELLED: "취소됨" };
export const PLAY_STATUS_LABEL: Record<string, string> = { CREATED: "공개 전", REVEALED: "결과 공개", CANCELLED: "취소됨" };
export const POLICY_LABEL: Record<RedeemPolicy, string> = { ANYTIME: "기간 내 사용", SAME_DAY: "발급 당일 사용", NEXT_DAY: "다음 날부터 사용" };

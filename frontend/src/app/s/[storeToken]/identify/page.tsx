    ...
    <main className="shell">
      ...
      >
        ...
        <div className="field">
          ...
          <input id="phone" type="tel" inputMode="numeric" placeholder="01012345678" value={phone} onChange={(e) => setPhone(e.target.value)} required />
        </div>
        <label className="check">
          <input type="checkbox" checked={agreed} onChange={(e) => setAgreed(e.target.checked)} required />
          <span>참여 확인 및 쿠폰 제공을 위한 개인정보 수집·이용에 동의합니다.</span>
        </label>
        {cooldown && <p className="notice">이미 최근에 참여하셨습니다. {cooldown.nextPlayableDate}부터 다시 참여할 수 있어요.</p>}

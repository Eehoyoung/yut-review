...
export const metadata: Metadata = { title: "개인정보처리방침 | 소담한판" };
export const dynamic = "force-dynamic";

export default function PrivacyPage() {
  return (
    <main className="legal-page">
      <header><p className="brand">소담한판</p><h1>개인정보처리방침</h1><p className="lead">시행일 및 버전: {ADMIN_PRIVACY_VERSION}</p></header>
      <section><h2>1. 처리 목적과 항목</h2><p>회사는 서비스 가입·인증, 매장 운영, 고객 참여·쿠폰 제공, 보안과 문의 처리를 위해 필요한 최소한의 개인정보를 처리합니다.</p><ul><li>매장 관리자: 대표자 이름, 휴대폰 번호, 이메일, 비밀번호 해시, 매장명, 사업자등록번호, 선택 입력한 주소</li><li>선택 동의한 매장 관리자: 대표자 휴대폰 번호를 선택한 소담랩스 서비스의 광고성 문자 전송에 이용합니다. 소담한판·리뷰파일럿·소담 동의는 각각 분리됩니다.</li><li>이벤트 고객: 이름, 휴대폰 번호, 참여 매장, 게임 결과, 당첨 상품·쿠폰 상태, 참여·사용 시각</li><li>보안 처리 정보: 접속 IP, 로그인 및 직원 PIN 실패 정보. 부정 이용 방지 목적에 필요한 범위에서 일시 처리됩니다.</li></ul></section>

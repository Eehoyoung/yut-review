...
## 직원 PIN 검증
```http
POST /api/public/stores/{storeToken}/staff-verify
```
Request:
```json
{ "pin": "483921" }
...
```json
{
  "verificationToken": "staff_verify_xxx",
  "expiresInSeconds": 180
}
```

`verificationToken`은 짧은 수명의 1회성 토큰으로 구현한다.
...
```json
{
  ...
  "name": "홍길동",
  "phone": "01012345678",
  "staffVerificationToken": "staff_verify_xxx",
  "idempotencyKey": "uuid"
}
```
Response:
